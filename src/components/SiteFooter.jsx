...
const socialLinks = [
  ...
  //         strokeWidth="1.8"
  //       />
  //       <circle cx="12" cy="12" r="4.15" fill="none" stroke="currentColor" strokeWidth="1.8" />
  ...
  //     <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
  //       <path
  //         d="M13.6 20.5v-7h2.6l.45-3h-3.05V8.6c0-.88.3-1.48 1.57-1.48h1.66V4.44c-.29-.04-1.27-.12-2.4-.12-2.37 0-4 1.44-4 4.1v2.08H8v3h2.39v7h3.21z"
  //         fill="currentColor"
  //       />
  //     </svg>
  //   ),
  ...
  if (type === 'website') {
    return (
      <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
        ...
        <path d="M3.9 12h16.2M12 3.9c2.2 2.35 3.35 5.18 3.35 8.1S14.2 17.75 12 20.1c-2.2-2.35-3.35-5.18-3.35-8.1S9.8 6.25 12 3.9z" fill="none" stroke="currentColor" strokeWidth="1.8" />
      </svg>
    )
  }
  ...
  if (type === 'email') {
    return (
      <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
        ...
        <path d="M5 7l7 5.2L19 7" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )
  }
      ...
      <div className="mx-auto max-w-[1580px] px-6 py-14 sm:px-8 sm:py-16 lg:px-10 lg:py-20">
        <div className="flex flex-col gap-10 xl:flex-row xl:items-start xl:justify-between">
          <div className="max-w-[50rem]">
            ...
            <h2 className="mt-8 text-[clamp(2.8rem,7vw,6.8rem)] font-semibold leading-[0.94] tracking-[-0.055em] text-white">
              ...
              <br />
              <span className="text-[#e53935]">market-ready</span>
              <br />
        ...
        <div className="mt-14 grid grid-cols-1 gap-10 border-t border-white/10 pt-12 lg:grid-cols-[1.1fr_1.1fr_1.2fr]">
          <div>
            ...
            <div className="mt-4 flex items-start gap-3 text-white/68">
              ...
              <div>
                <p className="text-base text-white">Tirupur, Tamil Nadu</p>
          ...
          <div>
            ...
            <div className="mt-4 flex items-start gap-3 text-white/68">
              <DetailIcon type="location" />
              <div>
                <p className="text-base text-white">United Arab Emirates
                 Distribution Office</p>
                {/* <p className="mt-1 text-sm uppercase tracking-[0.12em] text-white/48">
                  A Big Hub is Coming Soon
                </p> */}
              </div>
            </div>

             <h3 className="text-sm font-semibold uppercase tracking-[0.18em] text-white/88 mt-8">
              U.S.A
            </h3>
            <div className="mt-4 flex items-start gap-3 text-white/68">
              <DetailIcon type="location" />
          ...
          <div className="space-y-5">
            {/* <div className="flex items-start gap-3 text-white/68">
              <DetailIcon type="location" />
              <div>
                <p className="text-xs uppercase tracking-[0.18em] text-white/48">USA</p>
                <p className="mt-1 text-base text-white">Available Stores in USA</p>
                <p className="mt-1 text-sm uppercase tracking-[0.12em] text-white/48">
                  A Big Hub is Coming Soon
                </p>
              </div>
            ...
            <div className="flex items-start gap-3 text-white/68">
              ...
              <div>
                <p className="text-xs uppercase tracking-[0.18em] text-white/48">Website</p>
                <a
                  href="https://zealgroups.in"
                  target="_blank"
                  rel="noreferrer"
                  className="mt-1 inline-block text-base text-white transition hover:underline"
                >
                  zealgroups.in
                </a>
              </div>
            ...
            <div className="flex items-start gap-3 text-white/68">
              ...
              <div>
                <p className="text-xs uppercase tracking-[0.18em] text-white/48">Email</p>
                <a
            ...
            <div className="flex items-start gap-3 text-white/68">
              ...
              <div>
                <p className="text-xs uppercase tracking-[0.18em] text-white/48">Phone</p>
                <a
                  href="tel:04214244771"
                  className="mt-1 inline-block text-base text-white transition hover:underline"
                >
                  0421 424 4771
                </a>
        ...
        <div className="mt-12 border-t border-white/10 pt-7">
          ...
          <div className="mt-6 flex flex-col gap-3 text-sm text-white/48 lg:flex-row lg:items-center lg:justify-between">
            <p>© 2026 Zeal Creations. All rights reserved.</p>
            <Link to="/privacy-policy" className="transition hover:text-white hover:underline">
              Privacy Policy
            </Link>
          </div>
        </div>
