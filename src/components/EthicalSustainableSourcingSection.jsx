const certifications = [
  { title: 'SA 8000', subtitle: '2014 Standard', kind: 'shield' },
  { title: 'ISO 9001', subtitle: '2015 Certified', kind: 'badge' },
  { title: 'Sedex', subtitle: 'Member', kind: 'network' },
  { title: 'FAMA', subtitle: 'Certified', kind: 'document' },
]
...
const featureColumns = [
  ...
  ['Ethical Wage Structure', 'ESG Roadmap Implementation'],
]

function CertificationIcon({ kind }) {
  if (kind === 'shield') {
    return (
      <svg viewBox="0 0 48 48" className="h-11 w-11 text-[#e53935]" aria-hidden="true">
        <path
  ...
  if (kind === 'badge') {
    return (
      <svg viewBox="0 0 48 48" className="h-11 w-11 text-[#e53935]" aria-hidden="true">
        <circle cx="24" cy="18" r="10" fill="currentColor" fillOpacity="0.16" stroke="currentColor" strokeWidth="2" />
        <path d="M19 28l-3 12 8-4 8 4-3-12" fill="currentColor" fillOpacity="0.12" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
        <path d="M20.5 18h7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M24 14.5v7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      </svg>
    )
  }
  ...
  if (kind === 'network') {
    return (
      <svg viewBox="0 0 48 48" className="h-11 w-11 text-[#e53935]" aria-hidden="true">
        <circle cx="13" cy="15" r="5" fill="currentColor" fillOpacity="0.16" stroke="currentColor" strokeWidth="2" />
        <circle cx="35" cy="15" r="5" fill="currentColor" fillOpacity="0.16" stroke="currentColor" strokeWidth="2" />
        <circle cx="24" cy="33" r="5" fill="currentColor" fillOpacity="0.16" stroke="currentColor" strokeWidth="2" />
        <path d="M17.5 18.5l4.5 8M30.5 18.5l-4.5 8M18 15h12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      </svg>
    )
  }
  ...
  return (
    <svg viewBox="0 0 48 48" className="h-11 w-11 text-[#e53935]" aria-hidden="true">
      <rect x="11" y="7" width="26" height="34" rx="5" fill="currentColor" fillOpacity="0.14" stroke="currentColor" strokeWidth="2" />
      <path d="M18 18h12M18 24h12M18 30h8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M29 11v7h7" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
    </svg>
  )
}
  ...
  return (
    <section className="relative overflow-hidden  px-6 py-24 sm:px-8 sm:py-28 lg:px-10">
      <div
        ...
        style={{ backgroundImage: "url('/ethical-sourcing-bg.jpg')" }}
      />
      {/* <div className="pointer-events-none absolute inset-y-0 right-0 hidden w-[48%] bg-[linear-gradient(270deg,rgba(237,242,246,0.6),rgba(245,247,250,0.9)_48%,rgba(245,247,250,0)_100%)] xl:block" />
      <div className="pointer-events-none absolute -left-24 top-20 h-72 w-72 rounded-full bg-[radial-gradient(circle,_rgba(229,57,53,0.1),_rgba(229,57,53,0)_70%)] blur-3xl animate-[ambient-glow_11s_ease-in-out_infinite]" />
      <div className="pointer-events-none absolute right-[10%] top-[18%] hidden h-64 w-64 rounded-full bg-[radial-gradient(circle,_rgba(96,165,250,0.14),_rgba(96,165,250,0)_72%)] blur-3xl xl:block animate-[ambient-drift_14s_ease-in-out_infinite]" />
      <div className="pointer-events-none absolute bottom-12 right-[22%] hidden h-56 w-56 rounded-full bg-[radial-gradient(circle,_rgba(255,255,255,0.85),_rgba(255,255,255,0)_72%)] blur-3xl xl:block animate-[ambient-glow_13s_ease-in-out_infinite]" /> */}
        ...
        <div className="max-w-[52rem] xl:pr-8">
          <div className="flex flex-col">
            ...
            <p className="mt-7 max-w-[39rem] text-base leading-8 text-[#52606d] sm:text-[1.04rem]">
              We operate with full transparency, ensuring global compliance
            ...
            <div className="mt-12 grid grid-cols-2 gap-4 xl:grid-cols-4">
              {certifications.map((item) => (
                ...
                >
                  ...
                  <p className="mt-1.5 text-sm text-[#64748b]">{item.subtitle}</p>
                </article>
              ))}
            </div>
